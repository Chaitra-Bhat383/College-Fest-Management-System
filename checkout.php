...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_SESSION['cart'])) {
    ...
    $result = $db->query("INSERT INTO participants (participant_name, participant_email, participant_phone) VALUES ('$participant_name', '$participant_email', '$participant_phone')");
    if ($result) {
                ...
                <div class="col-md-8 order-md-1">
                    <form id="checkoutForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" autocomplete = "off" name="participant_name" id="participant_name" class="form-control" >
                        </div>
                        <div class="form-group">
                            <label for="participant_email" class="form-label">Email</label>
                            <input type="email" autocomplete = "off" name="participant_email" id="participant_email" class="form-control" >
                        </div>
                        <div class="form-group">
                            <label for="participant_phone" class="form-label">Phone</label>
                            <input type="text" autocomplete = "off" name="participant_phone" id="participant_phone" class="form-control" >
                        </div>
