...
if (isset($_POST['type']) && $_POST['type'] == 'add') {
    ...
    $result = $db->query("INSERT INTO organisers (organiser_name, organiser_email, organiser_phone) VALUES ('$organiser_name','$organiser_email', '$organiser_phone')");
    if ($result) {
                        ...
                        <form id="newOrganiserForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" novalidate>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" name="organiser_name" id="organiser_name" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="organiser_email" class="form-label">Email</label>
                                    <input type="text" autocomplete="off" name="organiser_email" id="organiser_email" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="organiser_phone" class="form-label">Phone</label>
                                    <input type="text" autocomplete="off" name="organiser_phone" id="organiser_phone" class="form-control">
                                </div>
                            </div>
                    ...
                    if ($result) {
                        while ($row = $result->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td><?php echo $row['organiser_email']; ?></td>
                                <td>
